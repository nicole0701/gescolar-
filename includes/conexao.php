...
/**
  * O laço try { } catch serve pra tentar executar um código. Caso algum erro
...
try {
    ...
    // Aqui vamos definir cong=figurações para tratamento de erros e acentos.
    $config = array(POD::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION,
                    PDO::MYSQL_INIT_COMMAND => "SET NAMES utf8");

    // Aqui criamos uma variável que abriga o objeto PDO, a conexão com o MySQL.
    $conexão = new PDO("mysql:host=" . $host . ";dbname=" . $bd, $usuario, $senha, $config);
